...
class Player(BasePlayer):
    ...
    comprq9 = models.IntegerField(choices=[[1,
                                           ...
                                           [2,
                                            'Die Schätzung eines zufällig gezogenen Schätzgeräts entspricht mit geringerer Wahrscheinlichkeit der tatsächlichen Zahl als jeder anderen Zahl. '
                                            'Je weiter man sich von Zahl x entfernt, desto wahrscheinlicher ist es, dass ein Schätzgerät eine solche Schätzung meldet.'],
                                           [3,
                                            ' Die Schätzung eines zufällig gezogenen Schätzgeräts entspricht mit größerer Wahrscheinlichkeit der tatsächlichen Zahl als jeder anderen Zahl. '
...
def comprq8_choices(player):
    if player.round_number == 12:
        ...
        choice_1 = 'Ich werde die Schätzungen von 4 Sendern beobachten. ' \
                   'Ich werde die Schätzungen von Sender A, Sender B, Sender C und die niedrigste Schätzung der folgenden 3 Sender betrachten: ' \
                   'Sender D, Sender E und Sender F. ' \
                   'Die niedrigste der drei Schätzungen ist im Durchschnitt ' + str(player.diff_high_low) + ' niedriger als die zweitniedrigste und ' + str(player.diff_high_mid) + ' niedriger als die höchste.'
        choice_2 = 'Ich werde die Schätzungen von 4 Sendern beobachten. ' \
                   'Ich werde die Schätzungen von Sender A, Sender B, Sender C und die höchste Schätzung der folgenden 3 Sender sehen: ' \
                   'Sender D, Sender E und Sender F. ' \
                   'Die zweithöchste Schätzung ist im Durchschnitt ' + str(player.diff_high_mid) + ' niedriger als die höchste, und die niedrigste Schätzung ist im Durchschnitt ' + str(player.diff_high_low) + ' niedriger als die höchste.'
        ...
        choice_3 = 'Ich werde die Schätzungen von 4 Sendern beobachten. ' \
                   'Ich werde die Schätzungen von Sender A, Sender B, Sender C und die höchste Schätzung der folgenden 3 Sender sehen: ' \
                   'Sender D, Sender E und Sender F. ' \
                   'Die zweithöchste Schätzung ist im Durchschnitt ' + str(diff_high_mid_new) + ' niedriger als die höchste, und die niedrigste Schätzung ist im Durchschnitt ' + str(diff_high_low_new) + ' niedriger als die höchste.'
...
class Instructions_GT_receivers(Page):
    ...
    form_model = "player"
    form_fields = ["comprq7", "comprq8", "comprq9", "comprq10", "comprq11", "comprq12", "comprq13", "comprq15"]
