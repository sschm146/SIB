...
class Player(BasePlayer):
    ...
    comprq7 = models.IntegerField(
        choices=[[1, 'The sender whose estimate I will observe first observed an estimate of 1 randomly drawn estimation device. '
                     'The other 6 senders observed 3 randomly drawn estimation devices.'],
                 [2, 'The sender whose estimate I will observe first observed an estimate of 3 randomly drawn estimation device. '
    ...
    comprq8 = models.IntegerField(choices=[[1, 'For each estimation task, I observe an estimate of 1 randomly drawn estimation device every time I estimate x.'],
                                           ...
                                           [3, 'For each estimation task, I will first see the estimate of 1 randomly determined sender after which I will state my first estimate of x. '
                                               ...
                                               'The senders’ names and group affiliation will not be shown.'],
                                  ...
                                  widget=widgets.RadioSelect,
                                  label='')
    comprq9 = models.IntegerField(choices=[[1, 'Sender X, Sender Y, and Sender X are members of my group (X) while Sender Y, Sender X, and Sender Y are members of Y group.'],
                                           [2, 'Sender Y, Sender X, and Sender Y are members of my group (X) while Sender X, Sender Y, and Sender X are members of Y group.'],
                                           [3, 'Sender X, Sender X, and Sender X are members of my group (X) while Sender Y, Sender Y, and Sender Y are members of Y group.']],
                                  widget=widgets.RadioSelect,
                                  label='')
    comprq10 = models.IntegerField(choices=[[1,'The number I state as my second estimation of x can be any number.'],
    ...
    comprq13 = models.IntegerField(
        ...
        widget=widgets.RadioSelect,
        label='')
    comprq14 = models.IntegerField(choices=[[1, '9'],
                                            [2, '18'],
                                            [3, '19'],
                                            [4, '24']],
                                   widget=widgets.RadioSelect,
