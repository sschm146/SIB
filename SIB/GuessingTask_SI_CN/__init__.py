...
class Player(BasePlayer):
    ...
    comprq6_CN = models.IntegerField(
    ...
    comprq11 = models.IntegerField(choices=[[1,
                                            ...
                                            [2,
                                             'Die Schätzung eines zufällig gezogenen Schätzgeräts entspricht mit geringerer Wahrscheinlichkeit der tatsächlichen Zahl x als jeder anderen Zahl. '
                                             'Je weiter man sich von Zahl x entfernt, desto wahrscheinlicher ist es, dass ein Schätzgerät eine solche Schätzung meldet.'],
                                            [3,
                                             'Die Schätzung eines zufällig gezogenen Schätzgeräts entspricht mit größerer Wahrscheinlichkeit der tatsächlichen Zahl x als jeder anderen Zahl. '
                                             'Je weiter man sich von Zahl x entfernt, desto unwahrscheinlicher ist es, dass ein Schätzgerät eine solche Schätzung meldet.']],
                                   widget=widgets.RadioSelect,
                                   label='')
    comprq12 = models.IntegerField(choices=[[1,
                                   ...
                                   widget=widgets.RadioSelect,
                                   label='')
    comprq12_2 = models.IntegerField(
